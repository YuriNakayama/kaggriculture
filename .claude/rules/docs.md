...
```
docs/experiment/{rulebase|imitation|reinforce}/{yyyymmdd}_case{N}_{topic}/{plan|result|etc.}.md
```

- **First segment**: agent family the experiment targets — `rulebase`, `imitation`, or `reinforce`.
