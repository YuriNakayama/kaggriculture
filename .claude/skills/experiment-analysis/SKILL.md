...
description: >
  Replay-driven post-mortem skill for finished Kaggriculture experiments. Selects
...
# Experiment Analysis Skill (Kaggriculture)
...
- Worktree `data/` is a symlink; the actual replays live under `/Users/user/project/kaggriculture/data/...`. **Pass absolute paths to the script.**
...
python3 .claude/skills/experiment-analysis/scripts/pick_match_pair.py \
  --replays-dir /Users/user/project/kaggriculture/data/lake/selfplay/matches/replays \
  --self-player-id 1 \
  --limit 200
```
