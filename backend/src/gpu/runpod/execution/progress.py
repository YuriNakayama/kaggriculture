...
`s3://$KAGGRICULTURE_DVC_BUCKET/runpod_progress/<RUN_ID>/<TIMESTAMP>_<STEP>`
...
# Account-specific; see KAGGRICULTURE_DVC_BUCKET in .claude/rules/infra.md.
PROGRESS_BUCKET = os.environ.get("KAGGRICULTURE_DVC_BUCKET", "")
